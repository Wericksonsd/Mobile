            ...
            <View style={{ justifyContent: "flex-end" }}>
                <View style={estilos.botao}>
                    <Pressable
                        ...
                        <Text style={estilos.texto} onPress={mostraPopup}>Apagar</Text>
                    </Pressable>
                </View>
            </View>
            <Modal visible={visuModal} transparent onRequestClose={visuModal}>
                <View style={estilos.background}>
                    <View style={estilos.viewPopup}>
                        ...
                        <View style={estilos.viewBotao}>
                            <TouchableOpacity style={estilos.botaoPopup} onPress={() => { props.navigation.navigate("DrawerNavigator") }}>
                                <Text style={estilos.texto}>SIM</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[estilos.botaoPopup, { backgroundColor: "#3F92C5" }]} onPress={mostraPopup}>
